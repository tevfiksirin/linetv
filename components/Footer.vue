      ...
      >
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          ...
          <nav class="mb-10 list-none">
            <li>
              <NuxtLink to="/kunye" class="text-gray-600 hover:text-gray-800">
                Künye
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/gizlilikPolitikasi" class="text-gray-600 hover:text-gray-800">
                Gizlilik Politikası
              </NuxtLink>
            </li>
            <li>
          ...
          <nav class="mb-10 list-none">
            <li>
              <a class="text-gray-600 hover:text-gray-800"
                >Panayır Mahallesi İstanbul Caddesi No: 365</a
              >
            </li>
            <li>
              <a class="text-gray-600 hover:text-gray-800"
                >16250 Osmangazi / BURSA</a
              >
            </li>
            <li>
              <a class="text-gray-600 hover:text-gray-800"
                >Tel: (0224) 211 70 90</a
              >
            </li>
            <li>
              <a class="text-gray-600 hover:text-gray-800"
                >Fax: (0224) 211 51 53</a
              >
            </li>
          </nav>
        </div>

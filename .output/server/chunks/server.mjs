...
const _routes = [
  {
    ...
    component: () => import('./canliyayin.9dd5e1f0.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index.50250d39.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./programlar.1b9447f4.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.915f6258.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

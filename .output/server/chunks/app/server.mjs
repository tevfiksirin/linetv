import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/canliyayin-25d3981f.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/gizlilikPolitikasi-8834b2b7.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-14790ec5.mjs').then((m) => m.default || m)
  },
  {
    name: "kullanimSartnamesi",
    path: "/kullanimSartnamesi",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/kullanimSartnamesi-46e1b0b0.mjs').then((m) => m.default || m)
  },
  {
    name: "kunye",
    path: "/kunye",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/kunye-b1640f92.mjs').then((m) => m.default || m)
  },
  {
    name: "nasilizlerim",
    path: "/nasilizlerim",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/nasilizlerim-b1b66ce7.mjs').then((m) => m.default || m)
  },
  {
    name: "ozgurlukyolu",
    path: "/ozgurlukyolu",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/ozgurlukyolu-f044fbb9.mjs').then((m) => m.default || m)
  },
  {
    name: "program",
    path: "/program",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/program-39693461.mjs').then((m) => m.default || m)
  },
  {
    name: "programlar",
    path: "/programlar",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/programlar-99a7ab49.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-7d1b378f.mjs').then((r) => r.default || r));

...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex flex-col h-screen gap-4 pl-20 pr-20 bg-secondary-500"><div class="flex justify-between gap-4 pt-12"><div class="flex flex-col justify-between w-7/12 h-52"><div><img${ssrRenderAttr("src", _imports_0)} alt=""></div><h1 class="text-xl font-bold tracking-wide text-primary-500">CANLI \u0130ZLE</h1></div><div class="flex items-end justify-start w-4/12"><div><img class="relative -top-6"${ssrRenderAttr("src", _imports_1)} alt=""><h1 class="text-xl font-bold tracking-wide text-primary-500">HABER S\u0130TEM\u0130Z</h1></div></div></div><div class="flex justify-between gap-4"><div class="w-7/12">`);
...
//# sourceMappingURL=index-c20b0659.mjs.map
